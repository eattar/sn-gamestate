...
class UnifiedBackboneModule(ImageLevelModule):
    ...
    input_columns = []
    output_columns = {
        "detection": ["bbox_ltwh", "confidence", "bbox_pitch", "keypoints_conf", "role", "track_id", "video_id", "category_id"],
    ...
    def _process_detections(self, detection_output: torch.Tensor, metadatas: pd.DataFrame) -> pd.DataFrame:
        ...
        for i in range(len(metadatas)):
            ...
            detection_data.append({
                ...
                "category_id": 1  # Add category_id for evaluation (1 = person class)
            })
